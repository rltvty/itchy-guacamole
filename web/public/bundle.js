...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    ...
	    getDeckByID: function getDeckByID(id) {
	      dispatch((0, _actions.SetLoading)(true));

	      (0, _api.fetchDeckByID)(id, function (deck) {
	        dispatch((0, _actions.SetDeck)(deck));
	        dispatch((0, _actions.SetLoading)(false));
	      });
	    }
	...
	var DeckContainer = (0, _reactRouter.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Deck));
