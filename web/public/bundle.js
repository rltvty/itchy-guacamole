...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function App() {
	  return React.createElement(
	    ...
	    { store: (0, _redux.createStore)(_reducers.Reducers, (0, _redux.applyMiddleware)(_reduxThunk2.default)) },
	    React.createElement(
	      _reactRouter.Router,
	      { history: _reactRouter.browserHistory },
	      React.createElement(_reactRouter.Route, { path: '/(:id)', component: Layout })
	    )
	  );
	};

	(0, _reactDom.render)(React.createElement(App, null), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _useRouterHistory2 = __webpack_require__(67);

	var _useRouterHistory3 = _interopRequireDefault(_useRouterHistory2);

	var _applyRouterMiddleware2 = __webpack_require__(68);

	var _applyRouterMiddleware3 = _interopRequireDefault(_applyRouterMiddleware2);

	var _browserHistory2 = __webpack_require__(69);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _useRouterHistory = __webpack_require__(67);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HashProtocol = __webpack_require__(79);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.DeckReducer = exports.Loading = exports.Error = exports.Deck = exports.DeckContainer = undefined;
	...
	var Deck = function Deck(_ref) {
	  ...
	  return React.createElement(_cards.Cards, { deck: deck });
	};

	var DeckContainer = (0, _reactRedux.connect)(mapStateToProps)(Deck);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Cards = exports.CardsContainer = undefined;

	var _reactRedux = __webpack_require__(3);

	var _Meta = __webpack_require__(83);
	...
	var Card = function Card(_ref) {
	  ...
	  var setName = card.set.split('_').join(' ');
	  var cardImg = '/static/images/dominion-cards/' + card.name.split(' ').join('_') + '.jpg';
	  ...
	  return React.createElement(
	    ...
	    React.createElement(
	      ...
	      deck.cards.map(function (card, index) {
	        return React.createElement(Card, { key: index, card: card });
	      })
	    ),
	    React.createElement(
	      'a',
	      { id: 'share-deck', title: 'Share this deck', href: "/?id=" + deck.id, target: '_blank' },
	      'Share this deck'
	    )
	  );
	};

	var CardsContainer = (0, _reactRedux.connect)(mapStateToProps)(Cards);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Meta = exports.MetaContainer = undefined;

	var _reactRedux = __webpack_require__(3);

	var getSets = function getSets(cards) {
	  var sets = [];

	  cards.forEach(function (item) {
	    var setName = item.set.split("_").join(" ");
	    if (!sets.includes(setName)) {
	      sets.push(setName);
	    }
	  });

	  return sets.sort().map(function (set, index) {
	    return React.createElement(
	      "li",
	      { key: index },
	      set
	...
	var getResources = function getResources(deck) {
	  var resources = [];

	  if (deck.potions) {
	    resources.push("Potions");
	  }
	  if (deck.ruins) {
	    resources.push("Ruins");
	  }
	  if (deck.shelters) {
	    resources.push("Shelters");
	  }
	  if (deck.spoils) {
	    resources.push("Spoils");
	  }
	  if (deck.colonies_and_platinums) {
	    resources.push("Colonies/Platinums");
	  }

	  return resources.sort().map(function (set, index) {
	    return React.createElement(
	      "li",
	      { key: index },
	      set
	  ...
	  return React.createElement(
	    ...
	    React.createElement(
	      ...
	      React.createElement(
	        "ul",
	        null,
	        getHardware(deck.hardware)
	      )
	    )
	  );
	};

	var MetaContainer = (0, _reactRedux.connect)(mapStateToProps)(Meta);
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  return React.createElement(
	    ...
	    React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'button',
	          { id: 'deck-new', title: 'New Deck', className: 'btn btn-primary', onClick: newDeck },
	          'New Deck'
	        )
	      )
	    )
	...
	var NavContainer = (0, _reactRedux.connect)(null, mapDispatchToProps)(Nav);
